...
export default function ComoTrabalhamos() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-poppins">
      ...
      {/* ── Sub-tabs ── */}
      <section className="bg-[#EF7933] px-8 pt-6 pb-4 flex flex-col items-center gap-6">
      ...
      {/* ── Hero ── */}
      <section className="bg-[#EF7933] px-8 pb-16">
        <div className="max-w-5xl mx-auto flex items-center gap-10">
          ...
          <img
            ...
            alt="Mural Electi"
            className="w-[520px] h-[300px] object-cover rounded-3xl border-[12px] border-[#FAB834] flex-shrink-0"
          />
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-12">
          ...
          <div className="flex gap-7 items-start">
            ...
            <div className="flex flex-col gap-7 flex-1">
              {/* Pensadores */}
              <div className="bg-white rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-8 flex flex-col gap-6">
                <h3 className="text-[#5B4696] text-2xl font-semibold">
            ...
            <div className="flex flex-col gap-7 flex-1">
              {/* Reggio Emilia */}
              <div className="bg-white rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-8 flex flex-col gap-4">
                <h3 className="text-[#5B4696] text-2xl font-semibold">
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-16">
          ...
          <div className="flex gap-12 items-start">
            <img
              ...
              className="flex-1 h-[290px] object-cover rounded-3xl border-[12px] border-[#FAB834]"
            />
            <img
              src="/images/d78d8dca4b53ebeced4a1a6f9446bc108949b333.webp"
              alt="Criança com fantasia"
              className="w-[290px] h-[290px] object-cover rounded-3xl border-[12px] border-[#34B7C0] flex-shrink-0"
            />
            <img
              src="/images/38757c54fef551a2732c49a135e1a374d291ad80.webp"
              alt="Projeto escolar"
              className="w-[290px] h-[290px] object-cover rounded-3xl border-[12px] border-[#AECB3C] flex-shrink-0"
            />
          </div>

          {/* Metodologias de projetos */}
          <div className="flex items-center gap-8">
            <h3 className="text-[#5B4696] text-5xl font-semibold leading-tight w-[380px] flex-shrink-0">
              Metodologias{"\n"}de projetos
            </h3>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="relative w-[170px] h-[170px] rounded-full bg-[#FAB834] flex-shrink-0">
              <img
                src="/images/d4eb26617991262160d516cf6d58e4ac9f93aac9.webp"
                alt="Andorinha mascote"
                className="absolute bottom-0 left-4 w-[110px] object-contain"
              />
            </div>

            {/* Leopard – rounded square teal */}
            <div className="relative w-[170px] h-[170px] rounded-[40px] bg-[#2FB6B7] flex-shrink-0 overflow-visible">
              <img
                src="/images/5cce40378e2efeeb58cc8b662e0bfaec5d2be101.webp"
                alt="Onça mascote"
                className="absolute -top-6 left-2 w-[130px] object-contain"
              />
            </div>

            {/* Dolphin – rounded square green */}
            <div className="relative w-[170px] h-[170px] rounded-[40px] bg-[#AECB3C] flex-shrink-0 overflow-visible">
              <img
                src="/images/b47bfbf700d85093886f85e709a3359ae274d7b8.webp"
                alt="Boto mascote"
                className="absolute -top-5 -left-4 w-[210px] object-contain"
              />
            </div>

            {/* Frog – mixed border-radius orange */}
            <div
              className="relative w-[170px] h-[170px] flex-shrink-0 bg-[#EF7933] overflow-visible"
              style={{ borderRadius: "200px 40px 40px 40px" }}
            >
              <img
                src="/images/1c40150a47e3ebfd360dfa3de5bd804aad930661.webp"
                alt="Boana mascote"
                className="absolute top-10 left-8 w-[115px] object-contain"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex flex-wrap gap-3 flex-1">
              {EXPERIENCIA_TAGS.map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center px-2 py-1 bg-[#FAB834] text-[#5B4696] font-semibold text-2xl"
                >
                  {tag}
                </span>
              ))}
      ...
      {/* ── Video Section ── */}
      <section className="relative flex items-center justify-center py-32 bg-gray-900 overflow-hidden">
        {/* bokeh overlay */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_50%,rgba(250,184,52,0.35)_0%,transparent_60%),radial-gradient(ellipse_at_80%_30%,rgba(250,184,52,0.25)_0%,transparent_50%),radial-gradient(ellipse_at_60%_70%,rgba(250,184,52,0.2)_0%,transparent_50%)] pointer-events-none" />
        {/* Play button */}
        <button className="relative z-10 w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-2xl hover:scale-105 transition-transform">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
            <path d="M8 5v14l11-7L8 5z" fill="#5B4696" />
          </svg>
        </button>
        {/* Dots pagination */}
        <div className="absolute bottom-8 flex gap-2">
          {[0, 1, 2].map((i) => (
            <span
              key={i}
              className={`w-2.5 h-2.5 rounded-full ${i === 1 ? "bg-white" : "bg-white/40"}`}
            />
          ))}
        </div>
      </section>
      ...
      {/* ── 8 Pilares (yellow bg) ── */}
      <section className="bg-[#FAB834] px-8 py-16">
        <div className="max-w-5xl mx-auto flex flex-col gap-12">
          <div className="flex gap-12 items-start">
            {/* Left text */}
            <div className="flex flex-col gap-6 w-[340px] flex-shrink-0">
              <h2 className="text-[#5B4696] text-5xl font-semibold leading-tight">
                Metodologia autoral{" "}
            ...
            <div className="flex items-center gap-4 flex-1 overflow-hidden">
              ...
              <button
                ...
                className="w-14 h-14 rounded-full bg-[#5B4696] flex items-center justify-center flex-shrink-0 disabled:opacity-40 transition-opacity"
              >
              ...
              <div className="flex gap-6 overflow-hidden flex-1">
                {PILARES.slice(currentPilar, currentPilar + 2).map((pilar) => (
                  <div
                    key={pilar.number}
                    className="flex-1 min-w-0 bg-white rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-8 flex flex-col items-center gap-4"
                  >
                    <div className="w-12 h-12 rounded-full bg-[#FAB834] flex items-center justify-center">
                      <span className="text-[#EC6C05] text-4xl font-black leading-none">
                        {pilar.number}
                      </span>
                    </div>
                    <p className="text-[#5B4696] text-2xl text-center leading-normal">
                      {pilar.title}
                    </p>
                  </div>
                ))}
